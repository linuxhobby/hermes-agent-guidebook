...
def get_md_files(directory):
    """按编号顺序获取所有 Markdown 文件（仅白皮书章节，排除 README 等）"""
    md_files = sorted(
        [f for f in os.listdir(directory)
         if f.endswith('.md')
         and f != 'generate_pdf.py'
         and re.match(r'^\d{2}-', f)],
...
if __name__ == '__main__':
    input_directory = '/Users/marco.chan/Documents/GitHub/hermes-agent-guide'
    output_file = '/Users/marco.chan/Documents/Hermes-Agent白皮书-养马从入门到精通.pdf'
